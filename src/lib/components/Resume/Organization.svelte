...
<section class="flex flex-col md:flex-row justify-center my-8">
  <!--
    Left side (or above on small screens) is the organization name, location
    and logo
  -->
  <div
  ...
  <!--
    Right side (or below on small screens) is the main content of the section,
